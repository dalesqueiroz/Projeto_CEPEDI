...
urlpatterns = [
    ...
    path("remover_checklist/<int:matricula>/<int:id1>/", views.remover_checklist, name="remover_checklist"),
    ...
    path("dados_pei/<int:matricula>/", views.dados_pei, name="dados_pei"),
    path("editar_pei/<int:matricula>/", views.editar_pei, name="editar_pei"),
    path("editar_equipe_pei/<int:matricula>", views.editar_equipe_pei, name="editar_equipe_pei"),
    path("editar_diagnostico/<int:matricula>/", views.editar_diagnostico, name="editar_diagnostico"),
    path("editar_historico_escolar/<int:matricula>/", views.editar_historico_escolar, name="editar_historico_escolar"),
    path("editar_perfil_estudante/<int:matricula>/", views.editar_perfil_estudante, name="editar_perfil_estudante"),
    path("editar_checklist/<int:matricula>/<int:id1>", views.editar_checklist, name="editar_checklist"),
    path("editar_atividade/<int:matricula>/", views.editar_atividade, name="editar_atividade"),
