...
urlpatterns = [
    ...
    path("remover_habilidade_academica/<str:matricula>/<int:id1>/", views.remover_habilidade_academica, name="remover_habilidade_academica"),
    ...
    path("editar_habilidade_academica/<str:matricula>/<int:id1>/", views.editar_habilidade_academica, name="editar_habilidade_academica"),
